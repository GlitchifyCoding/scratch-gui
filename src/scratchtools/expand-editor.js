if (document.querySelector("div#app.scratchtools.expand") === null) {
    document.querySelector("div#app").className =
      "scratchtools expand " + document.querySelector("div#app").className;
    ...
    function expandEditor() {
      if (
        document.querySelector("div#app").firstChild.lastChild.firstChild
          .lastChild.style.zIndex === "-100"
      ) {
        document.querySelector(
          "div#app"
        ).firstChild.lastChild.firstChild.lastChild.style.zIndex = null;
        ...
        document.querySelector(
          "div#app"
        ).firstChild.lastChild.firstChild.lastChild.style.zIndex = "-100";
        document.querySelector("svg.blocklySvg").style.width = "100vw";
        document.querySelector("svg.blocklyScrollbarVertical").style.display =
          "none";
